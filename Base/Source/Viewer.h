...
public:			// Functions
	 ...
	 */
	virtual void SpottedTarget(Vector2 pos) = 0;		// Function to be called by the tile that stores the Viewers, to inform the Viewer of the Character that has entered the Viewer's viewing box
